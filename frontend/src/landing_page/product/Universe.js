...
baskets of stocks on ETFs.
          ...
          <div className="col-4 p-3 mt-5" >
            <img src="images/streakLogo.png" className="img-fluid" style={{maxWidth: "150px"}}/>
            <p className="text-small text-muted mt-3">Systematic trading platform
that allows you to create and backtest
strategies without coding.</p>
          </div>
          <div className="col-4 p-3 mt-5">
            <img src="images/dittoLogo.png" className="img-fluid" style={{maxWidth: "150px"}}/>
...
data points like open interest, FII/DII, and more.
          ...
          <div className="col-4 p-3 mt-5" >
            <img src="images/zerodhaFundhouse.png" className="img-fluid" style={{maxWidth: "150px"}}/>
...
funds to help you save for your goals.
          ...
          <div className="col-4 p-3 mt-5">
            <img src="images/goldenpiLogo.png" className="img-fluid" style={{maxWidth: "150px"}}/>
